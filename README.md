...
- CMS_AI_DB は既存の homepage-hatt-comments D1、CMS_AI_ASSETS は既存の非公開 homepage-hatt-shop-files R2を専用prefixで利用します。migrations/0002_create_cms_ai_jobs.sql をD1へ適用してください。
- Workers AI binding AI をPagesへ追加します。@cf/zai-org/glm-5.3-flash の利用にはWorkers Paidまたはprepaid AI Gateway creditsが必要です。
