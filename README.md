...
- CMS_AI_DB は既存の homepage-hatt-comments D1を利用します。`migrations/0002_create_cms_ai_jobs.sql`、`migrations/0003_add_cms_ai_reasoning_effort.sql`、`migrations/0004_add_cms_ai_conversations.sql` を順にD1へ適用してください。
