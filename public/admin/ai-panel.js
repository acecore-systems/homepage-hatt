;(function initCmsAiPanel() {
  ...
  panel.innerHTML = [
    ...
    '        <option value="low">低（速さ優先）</option>',
    '        <option value="medium" selected>標準（おすすめ）</option>',
    '        <option value="high">高（複雑な修正向け）</option>',
    '      </select>',
    '    </label>',
    '    <p class="cms-ai-form__hint">高いほど丁寧に考えますが、完了までの時間と利用量が増える場合があります。</p>',
